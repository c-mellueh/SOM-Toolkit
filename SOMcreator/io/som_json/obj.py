...
from SOMcreator.io.som_json.constants import IFC_MAPPINGS, ABBREVIATION, PROPERTY_SETS, IDENT_ATTRIBUTE, OBJECTS
...
def _load_object(proj: SOMcreator.Project, object_dict: ObjectDict, identifier: str) -> SOMcreator.Object:
    ...
    if ident_attrib_id is not None:
        ident_attrib = SOMcreator.io.som_json.attribute_uuid_dict[ident_attrib_id]
        obj.ident_attrib = ident_attrib
    SOMcreator.io.som_json.parent_dict[obj] = parent
    SOMcreator.io.som_json.object_uuid_dict[identifier] = obj
