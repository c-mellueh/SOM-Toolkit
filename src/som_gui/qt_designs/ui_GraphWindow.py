...
class Ui_GraphView(object):
    def setupUi(self, GraphView):
        ...
        self.gridLayout.addWidget(self.button_delete, 0, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.button_reload, 0, 4, 1, 1)

        self.button_filter = QToolButton(GraphView)
        self.button_filter.setObjectName(u"button_filter")

        self.gridLayout.addWidget(self.button_filter, 0, 1, 1, 1)
