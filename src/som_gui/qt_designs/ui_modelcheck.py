...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("Dialog", u"Fehlertyp", None));
        ___qtablewidgetitem1 = self.table_widget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("Dialog", u"Beschreibung", None));
    # retranslateUi
