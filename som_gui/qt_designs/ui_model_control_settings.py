...
################################################################################
## Form generated from reading UI file 'ModelControlSettings.ui'
##
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.check_box_existing_attributes.setText(QCoreApplication.translate("Dialog", u"Bereits existierende Vorgaben anzeigen", None))
