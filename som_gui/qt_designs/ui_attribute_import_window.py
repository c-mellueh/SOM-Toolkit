...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy6.setHeightForWidth(self.button_last.sizePolicy().hasHeightForWidth())
        self.button_last.setSizePolicy(sizePolicy6)
        self.button_last.setMinimumSize(QSize(0, 24))
        ...
        sizePolicy5.setHeightForWidth(self.label_object_name.sizePolicy().hasHeightForWidth())
        self.label_object_name.setSizePolicy(sizePolicy5)
        self.label_object_name.setMinimumSize(QSize(0, 24))
        ...
        self.button_next.setMinimumSize(QSize(0, 24))
        ...
        sizePolicy7.setHeightForWidth(self.splitter_tables.sizePolicy().hasHeightForWidth())
        self.splitter_tables.setSizePolicy(sizePolicy7)
        ...
        sizePolicy8.setHeightForWidth(self.table_widget_attribute.sizePolicy().hasHeightForWidth())
