...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_project_name = QLineEdit(Dialog)
        self.lineEdit_project_name.setObjectName(u"lineEdit_project_name")

        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.lineEdit_project_name)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.lineEdit_author)
        ...
        self.lineEdit_version = QLineEdit(Dialog)
