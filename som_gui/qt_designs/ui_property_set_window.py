...
class Ui_layout_main(object):
    def setupUi(self, layout_main):
        ...
        self.layout_grid.addWidget(self.button_add, 2, 4, 1, 2)
        ...
        self.layout_grid.addWidget(self.check_box_seperator, 4, 3, 1, 1)

        self.spacer = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.layout_grid.addItem(self.spacer, 8, 1, 1, 1)
        ...
        self.layout_grid.addWidget(self.button_add_line, 4, 5, 1, 1)
        ...
        self.layout_grid.addWidget(self.line_edit_seperator, 4, 4, 1, 1)
        ...
        self.layout_grid.addWidget(self.label_values, 4, 1, 1, 1)

        self.label = QLabel(layout_main)
        self.label.setObjectName(u"label")

        self.layout_grid.addWidget(self.label, 9, 1, 1, 1)
        ...
        self.layout_grid.addWidget(self.label_name, 2, 1, 1, 1)

        self.check_box_inherit = QCheckBox(layout_main)
        self.check_box_inherit.setObjectName(u"check_box_inherit")

        self.layout_grid.addWidget(self.check_box_inherit, 4, 2, 1, 1)
        ...
        self.layout_grid.addWidget(self.lineEdit_name, 3, 1, 1, 5)

        self.verticalLayout = QVBoxLayout()
        self.verticalLayout.setObjectName(u"verticalLayout")

        self.layout_grid.addLayout(self.verticalLayout, 6, 1, 1, 5)
        ...
        self.layout_grid.addWidget(self.description, 10, 1, 1, 5)
