...
class Class:
    def add_class_activate_function(self, func): pass
    ...
    def fill_class_entry(self, som_class): pass
    ...
    def trigger_class_copy(self, som_class, data_dict): pass

    def trigger_class_creation(self, data_dict): pass

    def trigger_class_modification(self, som_class, data_dict): pass
...
class ClassTree:
    def add_column_to_tree(self, tree, name_getter, index, getter_func, setter_func): pass
    ...
    def create_item(self, tree, som_class): pass
    ...
    def fill_class_tree(self, tree, classes, parent_item): pass
    ...
    def get_item_from_class(self, tree, som_class): pass

    def get_item_from_pos(self, tree, pos): pass
    ...
    def group_selection(self, tree): pass

    def handle_class_move(self, tree, dropped_on_item): pass

    def is_drop_indication_pos_on_item(self, tree): pass

    def is_first_paint(self, tree): pass
    ...
    def select_class(self, tree, som_class): pass

    def set_class_optional_by_tree_item_state(self, item, column_index): pass

    def set_column_list(self, tree, value): pass

    def set_first_paint(self, tree, value): pass

    def trigger_search(self, tree): pass

    def trigger_tree_init(self, tree): pass

    def update_check_state(self, tree, item): pass

    def update_item(self, tree, item, som_class): pass
...
class FilterWindow:
    ...
    def connect_class_tree(self, project): pass

    def connect_project_table(self, project): pass

    def connect_views(self, project, tree_model, splitter, view_1, view_2, first_columns): pass

    def create_context_menu(self, menu_list, pos): pass

    def create_header_views(self, project, first_columns): pass

    def create_widget(self, project): pass
    ...
    def set_class_label(self, value): pass
...
class MainWindow:
    ...
    def get_class_tree_widget(self, ): pass
    ...
    def trigger_class_changed(self, ): pass
...
class PropertySetWindow:
    ...
    def get_active_property(self, window): pass
    ...
    def get_property_data(self, window): pass

    def get_property_name_input(self, window): pass
    ...
    def get_unit_combobox(self, window): pass

    def get_value_type(self, window): pass

    def get_values(self, window): pass

    def get_window_by_lineedit(self, line_edit): pass

    def get_window_by_property_set(self, property_set): pass

    def ignore_builder(self, line_edit): pass

    def is_name_existing(self, name, window): pass
    ...
    def set_property_name(self, name, window): pass

    def set_selecteded_values_ignored(self, line_edit, ignore_state): pass

    def set_splitter_settings_widget(self, widget): pass

    def set_unit(self, unit, window): pass

    def set_value_columns(self, column_count, window): pass

    def set_value_type(self, value_type, window): pass

    def set_values(self, som_property, window): pass

    def trigger_property_activation(self, som_property, window): pass

    def trigger_window_open(self, property_set): pass

    def unignore_builder(self, line_edit): pass

    def update_add_button(self, window): pass

    def update_datatype_completer(self, window): pass

    def update_line_validators(self, window): pass

    def update_unit_completer(self, window): pass

    def update_valuetype_completer(self, window): pass
