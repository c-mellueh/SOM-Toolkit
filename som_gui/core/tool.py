...
class Appdata:
    ...
    def get_bool_setting(self, section, option, default): pass

    def get_float_setting(self, section, option, default): pass

    def get_ini_path(self, ): pass

    def get_int_setting(self, section, option, default): pass

    def get_list_setting(self, section, option, default): pass

    def get_path(self, value): pass

    def get_string_setting(self, section, option, default): pass

    def set_path(self, path, value): pass

    def set_setting(self, section, option, value): pass


class Bsdd:
    def add_classes_to_dictionary(self, project): pass
    ...
    def get_linked_property_name(self, item): pass
    ...
    def is_update_blocked(self, ): pass

    def reset_classes(self, ): pass

    def reset_dictionary(self, ): pass

    def reset_properties(self, ): pass

    def set_action(self, name, action): pass

    def set_linked_property_name(self, item, value): pass
...
class Class:
    def add_class_creation_check(self, key, check_function): pass

    def check_class_creation_input(self, data_dict): pass

    def connect_signals(self, ): pass

    def create_class(self, data_dict, property_set, identifier_property): pass

    def delete_class(self, som_class, recursive): pass

    def find_property(self, som_class, pset_name, property_name): pass

    def get_existing_ident_values(self, ): pass

    def get_properties(self, ): pass

    def group_classes(self, parent, children): pass

    def handle_property_issue(self, result): pass

    def inherit_property_set_to_all_children(self, som_class, property_set): pass

    def is_identifier_allowed(self, identifier, ignore, is_group): pass

    def modify_class(self, som_class, data_dict): pass

    def set_ident_value(self, som_class, value): pass
...
class ClassInfo:
    ...
    def append_ifc_lineedit(self, line_edit): pass

    def are_plugin_requirements_met(self, som_class, data_dict): pass

    def connect_dialog(self, dialog, predefined_psets): pass

    def create_dialog(self, title, ifc_versions): pass

    def create_ifc_completer(self, ): pass

    def generate_datadict(self, ): pass

    def get_active_class(self, ): pass

    def get_class_infos(self, ): pass

    def get_dialog(self, ): pass

    def get_ifc_lineedits(self, ): pass
    ...
    def is_ident_property_valid(self, data_dict): pass

    def is_ident_pset_valid(self, data_dict): pass

    def is_identifier_unique(self, data_dict): pass
    ...
    def remove_plugin_entry(self, key): pass

    def reset(self, ): pass

    def set_active_class(self, value): pass

    def trigger_class_info_widget(self, mode, som_class): pass

    def update_dialog(self, dialog): pass

    def update_property_combobox(self, predefined_psets): pass


class ClassTree:
    def add_column_to_tree(self, tree, name_getter, logical_index, getter_func, setter_func, role): pass

    def add_context_menu_entry(self, tree, name_getter, function, on_selection, single, multi): pass

    def add_tree(self, tree): pass

    def clear_context_menu_list(self, tree): pass

    def collapse_selection(self, tree): pass

    def connect_tree(self, tree): pass

    def connect_trigger(self, ): pass

    def create_completer(self, texts, widget): pass

    def create_context_menu(self, tree): pass

    def delete_selection(self, tree): pass

    def expand_selection(self, tree): pass

    def expand_to_class(self, tree, som_class): pass

    def get_class_from_index(self, index): pass

    def get_classes_from_mimedata(self, mime_data): pass

    def get_column_list(self, tree): pass

    def get_header_names(self, tree): pass

    def get_index_from_pos(self, tree, pos): pass

    def get_properties(self, ): pass

    def get_selected(self, tree): pass

    def get_selected_classes(self, tree): pass

    def get_trees(self, ): pass

    def group_classes(self, parent, children): pass

    def handle_class_move(self, tree, dropped_on_index): pass

    def insert_row_by_class(self, tree, som_class): pass

    def is_drop_indication_pos_on_item(self, tree): pass

    def remove_column_from_tree(self, tree, column_name): pass

    def remove_row_by_class(self, tree, som_class): pass

    def remove_tree(self, tree): pass

    def reset_tree(self, tree): pass

    def resize_tree(self, tree): pass

    def set_column_list(self, tree, value): pass

    def write_classes_to_mimedata(self, classes, mime_data): pass
...
class FilterCompare:
    ...
    def append_collumns(self, class_tree, pset_tree_widget): pass

    def are_all_filters_identical(self, filter_list): pass

    def are_classes_identical(self, class_0, class_1): pass

    def are_properties_identical(self, property_0, property_1): pass
    ...
    def export_class_filter_differences(self, file, property_compare): pass

    def export_property_filter_differnces(self, file, property_list): pass

    def export_pset_filter_differences(self, file, pset_list, property_compare): pass
    ...
    def style_class_tree(self, item): pass


class IfcImporter:
    def add_progress_bar(self, widget, progress_bar): pass

    def check_inputs(self, ifc_paths, main_pset, main_property): pass
    ...
    def get_main_property(self, widget): pass
...
class IfcSchema:
    def create_mapping_widget(self, som_class, version): pass

    def get_active_versions(self, ): pass

    def get_newest_version(self, versions): pass

    def get_properties(self, ): pass

    def get_property_sets_of_class(self, class_name, version): pass

    def read_jsons(self, version): pass

    def set_active_versions(self, versions): pass
...
class Language:
    ...
    def load_main_translations(self, app, lang_code): pass

    def load_plugin_translations(self, plugin_names, app, lang_code): pass

    def retranslate_main_ui(self, ): pass

    def retranslate_plugins(self, plugin_names): pass
...
class MainWindow:
    ...
    def connect_class_tree(self, ): pass
    ...
    def get_class_name_label(self, ): pass
    ...
    def get_property_table(self, ): pass

    def get_pset_name_label(self, ): pass
    ...
    def remove_action(self, parent_name, action): pass

    def remove_submenu(self, parent_name, sub_menu): pass

    def request_new_property(self, ): pass

    def set_action(self, name, action): pass

    def set_active_class(self, som_class): pass
...
class Mapping:
    def add_class_to_ifc_export_data(self, som_class): pass

    def connect_window_triggers(self, window): pass

    def create_child(self, entity): pass

    def create_export_dict(self, root_classes): pass

    def create_window(self, ): pass

    def disable_all_child_entities(self, item, disabled): pass

    def fill_class_tree(self, root_classes): pass
    ...
    def get_selected_class(self, ): pass
...
class Modelcheck:
    ...
    def add_issues(self, guid, description, issue_type, som_property, pset_name, property_name, value): pass

    def build_data_dict(self, check_state_dict): pass

    def build_ident_dict(self, classes): pass

    def check_datatype(self, value, som_property): pass

    def check_for_properties(self, element, som_class): pass

    def check_format(self, value, som_property): pass

    def check_list(self, value, som_property): pass

    def check_range(self, value, som_property): pass

    def check_values(self, value, som_property): pass
    ...
    def datatype_issue(self, guid, som_property, element_type, datatype, value): pass

    def db_create_entity(self, element, identifier): pass

    def disconnect_from_data_base(self, ): pass

    def empty_value_issue(self, guid, pset_name, property_name, element_type): pass

    def entity_should_be_tested(self, entity): pass

    def format_issue(self, guid, som_property, value): pass
    ...
    def get_class_checked_count(self, ): pass

    def get_class_count(self, ): pass

    def get_class_representation(self, entity): pass
    ...
    def get_ident_value(self, entity, main_pset_name, main_prop_name): pass

    def get_ifc_name(self, ): pass

    def get_main_property_name(self, ): pass

    def get_main_pset_name(self, ): pass

    def get_properties(self, ): pass

    def get_property_value(self, entity, pset_name, property_name): pass

    def guid_issue(self, guid, file1, file2): pass

    def ident_issue(self, guid, pset_name, property_name): pass

    def ident_pset_issue(self, guid, pset_name): pass

    def ident_unknown(self, guid, pset_name, property_name, value): pass
    ...
    def is_property_existing(self, entity, pset_name, property_name): pass

    def is_pset_existing(self, entity, pset_name): pass

    def list_issue(self, guid, som_property, element_type, value): pass

    def property_issue(self, guid, pset_name, property_name, element_type): pass

    def property_set_issue(self, guid, pset_name, element_type): pass

    def range_issue(self, guid, som_property, element_type, value): pass
    ...
    def set_class_checked_count(self, value): pass

    def set_class_count(self, value): pass
    ...
    def set_main_property_name(self, value): pass
...
class ModelcheckExternal:
    ...
    def export_desite_property_table(self, ): pass
    ...
    def get_main_property(self, ): pass
...
class ModelcheckWindow:
    ...
    def connect_class_tree(self, tree_widget): pass
    ...
    def create_class_tree_row(self, som_class): pass
    ...
    def fill_class_tree(self, entities, parent_item, model, tree): pass
    ...
    def resize_class_tree(self, tree): pass
    ...
    def set_selected_class(self, som_class): pass
    ...
    def update_class_tree_row(self, parent_item, row_index): pass


class Plugins:
    def activate_plugin(self, plugin_name): pass

    def create_settings_entry(self, plugin_name): pass

    def deactivate_plugin(self, plugin_name): pass
    ...
    def get_submodules(self, plugin_name): pass

    def is_plugin_active(self, plugin_name): pass

    def on_new_project(self, plugin_name): pass
...
class Popups:
    ...
    def _request_text_input(self, title, request_text, prefill, parent, completer): pass
    ...
    def request_property_name(self, old_name, parent): pass
...
class PredefinedPropertySet:
    def add_classes_to_table_widget(self, property_sets, table_widget): pass

    def add_property_sets_to_widget(self, property_sets, list_widget): pass

    def clear_class_table(self, ): pass

    def close_window(self, ): pass

    def connect_signals(self, ): pass

    def connect_window(self, window): pass

    def create_property_set(self, ): pass

    def create_window(self, ): pass

    def delete_selected_classes(self, ): pass
    ...
    def get_class_from_item(self, item): pass

    def get_class_table_widget(self, ): pass

    def get_existing_psets_in_list_widget(self, pset_list): pass

    def get_existing_psets_in_table_widget(self, class_table): pass
    ...
    def get_pset_by_name(self, name): pass
    ...
    def name_is_in_predefined_psets(self, name): pass
    ...
    def update_class_widget(self, ): pass
...
class Project:
    ...
    def get_root_classes(self, filter_classes, proj): pass
    ...
    def remove_plugin_save_function(self, index): pass
...
class Property:
    def add_property_data_value(self, name, getter, setter): pass

    def connect_signals(self, ): pass

    def create_by_dict(self, property_data): pass

    def get_allowed_unit_prefixes(self, appdata): pass

    def get_allowed_units(self, appdata): pass

    def get_checked_texts_from_list_widget(self, list_widget): pass

    def get_properties(self, ): pass

    def get_property_data(self, som_property): pass

    def get_unit_settings_widget(self, ): pass

    def set_data_by_dict(self, som_property, data_dict): pass

    def set_unit_settings_widget(self, widget): pass


class PropertyCompare:
    def add_class_to_item(self, som_class, item, index): pass

    def add_missing_classes_to_tree(self, tree, root_classes): pass

    def add_properties_to_pset_tree(self, tree, add_missing): pass

    def are_classes_identical(self, class_0, class_1, check_pset): pass

    def are_properties_identical(self, property_0, property_1): pass

    def are_property_sets_identical(self, property_set0, property_set1, check_properties): pass
    ...
    def compare_classes(self, class_0, class_1): pass

    def compare_properties(self, property_0, property_1): pass

    def compare_property_sets(self, pset_0, pset_1): pass

    def create_child_matchup(self, entity0, entity1): pass

    def create_class_dicts(self, ): pass

    def create_class_lists(self, ): pass
    ...
    def export_class_differences(self, file): pass
    ...
    def export_property_check(self, file, type_name, attrib0, attrib1, indent): pass

    def export_property_differences(self, file, property_list): pass

    def export_pset_differences(self, file, pset_list, lb): pass

    def fill_class_tree(self, tree, add_missing): pass

    def fill_class_tree_layer(self, classes, parent_item, add_missing): pass

    def fill_pset_tree(self, tree, pset_list, add_missing): pass

    def fill_table(self, table, info_list, entities): pass

    def fill_value_table(self, table, som_property): pass

    def fill_value_table_pset(self, widget): pass

    def find_existing_parent_item(self, som_class): pass

    def find_matching_class(self, som_class, index): pass
    ...
    def get_class_dict(self, ): pass

    def get_class_list(self, ): pass

    def get_class_tree(self, widget): pass
    ...
    def get_item_from_class(self, som_class): pass

    def get_level(self, index): pass

    def get_missing_classes(self, index): pass
    ...
    def get_property_info_list(self, ): pass

    def get_property_list(self, property_set): pass

    def get_pset_info_list(self, ): pass

    def get_pset_list(self, som_class): pass
    ...
    def set_class_item_relation(self, som_class, item): pass

    def set_header_labels(self, trees, tables, labels): pass

    def set_projects(self, project1, project2): pass

    def set_property_list(self, property_set, property_list): pass

    def set_pset_list(self, som_class, pset_list): pass
...
class PropertyImport:
    ...
    def set_main_property(self, main_property_name): pass
...
class PropertyImportResults:
    def build_property_dict(self, classes): pass

    def calculate_all_checkbox_state(self, ): pass

    def checkstate_to_int(self, checkstate): pass

    def connect_trigger(self, property_widget): pass

    def create_import_window(self, ): pass
    ...
    def get_property_item_text_color(self, row): pass
    ...
    def get_selected_property(self, ): pass
    ...
    def set_class_count_label_text(self, text): pass

    def unlock_updating(self, ): pass

    def update_combobox(self, combobox, allowed_values): pass

    def update_property_table_styling(self, ): pass

    def update_results_window(self, ): pass

    def update_som_combobox(self, combobox, allowed_values, class_list): pass
...
class PropertyImportSQL:
    def add_entity(self, entity, main_pset, main_property, file_name): pass

    def add_properties_to_filter_table(self, project, som_property): pass

    def add_property_with_value(self, som_property): pass

    def add_property_without_value(self, som_property): pass

    def are_entities_with_identifiers_existing(self, ): pass

    def change_checkstate_of_values(self, ifc_type, identifier, property_set, property_query, value_text, checkstate): pass

    def commit_sql(self, ): pass

    def connect_to_data_base(self, path): pass

    def count_classes(self, ifc_type, identifier): pass
    ...
    def fill_property_filter_table(self, values): pass

    def fill_som_properties(self, values): pass

    def get_current_class_filter(self, ): pass
    ...
    def get_new_property_values(self, ): pass

    def get_properties(self, ): pass

    def get_property_data(self, som_property): pass

    def get_property_list(self, ifc_type, identifier, property_set): pass

    def get_property_query(self, ): pass

    def get_property_sets(self, ifc_type, identifier): pass

    def get_removed_property_values(self, ): pass

    def get_settings_dialog_checkbox_list(self, dialog): pass

    def get_values(self, ifc_type, identifier, property_set, property_query): pass

    def get_wanted_ifc_types(self, ): pass

    def import_entity_properties(self, entity, ifc_file, identifier, existing_class_dict): pass

    def init_database(self, db_path): pass

    def set_current_class_filter(self, usecases, phases): pass
...
class PropertySet:
    ...
    def create_ifc_pset(self, name, ifc_version): pass

    def create_property_set(self, name, som_class, parent): pass
    ...
    def get_ifc_names(self, class_ifc_mappings, ifc_version): pass

    def get_inheritable_property_sets(self, som_class): pass

    def get_parent_by_name(self, name, som_class): pass

    def get_properties(self, ): pass

    def get_property_by_name(self, property_set, name): pass

    def get_property_set_from_item(self, item): pass

    def get_property_set_from_row(self, row, table): pass

    def get_property_sets(self, active_class): pass

    def get_pset_from_index(self, index): pass

    def get_pset_from_item(self, item): pass

    def get_pset_name_suggestion(self, som_class, predefined_psets, ifc_version): pass
    ...
    def is_name_in_ifc_psets(self, name, som_class, ifc_version): pass

    def is_name_in_parent_classes(self, name, som_class): pass

    def is_pset_existing(self, pset_name, active_class): pass

    def pset_table_is_editing(self, ): pass

    def remove_property_by_name(self, property_set, property_name): pass

    def remove_property_sets_from_table(self, property_sets, table): pass

    def rename_table_pset(self, ): pass

    def search_for_parent(self, pset_name, som_class, allowed_ifc_psets): pass
    ...
    def set_sorting_indicator(self, table_widget, col_index): pass

    def trigger_table_repaint(self, ): pass
...
class PropertyTable:
    ...
    def add_parent_of_selected_properties(self, table): pass

    def add_properties_to_table(self, properties, table): pass

    def connect_table(self, table): pass
    ...
    def delete_selected_properties(self, table, with_child): pass

    def edit_selected_property_name(self, table): pass
    ...
    def get_existing_properties(self, table): pass

    def get_header_labels(self, ): pass

    def get_item_from_pos(self, table, pos): pass

    def get_possible_parent(self, som_property): pass

    def get_properties(self, ): pass

    def get_property_dict_from_mime_data(self, mime_data): pass

    def get_property_from_item(self, item): pass

    def get_property_set_by_table(self, table): pass

    def get_property_set_of_table(self, table): pass

    def get_row_index_from_property(self, som_property, table): pass

    def get_selected_properties(self, table): pass

    def is_drop_allowed(self, event, target_table): pass

    def refresh_table(self, table): pass

    def remove_parent_of_selected_properties(self, table): pass

    def remove_properties_from_table(self, properties, table): pass

    def set_property_set_of_table(self, table, property_set): pass

    def update_row(self, table, index): pass

    def write_property_dicts_to_mime_data(self, property_dicts, mime_data): pass


class PropertyWindow:
    def add_context_menu_builder(self, context_menu_builder): pass

    def add_plugin_entry(self, key, layout_name, widget_creator, index, value_getter, value_setter, widget_value_setter, test_function): pass

    def add_value(self, table_view, value): pass

    def connect_signals(self, ): pass

    def connect_splitter_widget(self, widget): pass

    def connect_value_view(self, window): pass

    def create_window(self, som_property): pass

    def create_window_title(self, som_property): pass
    ...
    def get_datatype_combobox(self, widget_ui): pass

    def get_description_textedit(self, widget_ui): pass

    def get_properties(self, ): pass

    def get_property_from_window(self, window): pass

    def get_selected_rows(self, table_view): pass

    def get_selected_values(self, table_view): pass

    def get_splitter_settings_checkstate(self, widget): pass

    def get_splitter_settings_text(self, widget): pass

    def get_splitter_settings_widget(self, ): pass

    def get_ui(self, som_property): pass

    def get_unit_combobox(self, widget_ui): pass

    def get_valuetype_combobox(self, widget_ui): pass

    def get_window(self, som_property): pass

    def get_windows(self, ): pass

    def ignore_builder(self, table_view): pass

    def prefill_comboboxes(self, window): pass

    def remove_builder(self, table_view): pass

    def remove_plugin_entry(self, key): pass

    def remove_selected_values(self, table_view): pass

    def remove_window(self, window): pass

    def rename_property(self, som_property, value): pass

    def set_comboboxes_enabled(self, enabled_state, window): pass

    def set_datatype(self, som_property, value): pass

    def set_description(self, som_property, value): pass

    def set_optional(self, som_property, value): pass

    def set_selecteded_values_ignored(self, table_view, state): pass

    def set_splitter_settings_widget(self, widget): pass

    def set_unit(self, som_property, value): pass

    def set_value(self, table_view, row, value): pass

    def set_value_inherit_state(self, som_property, value): pass

    def set_values(self, table_view, start_row, values): pass

    def set_valuetype(self, som_property, value): pass

    def show_property_info(self, som_property): pass

    def unignore_builder(self, table_view): pass

    def update_unit_completer(self, window): pass
...
class Search:
    ...
    def get_row_matchscore(self, dialog, search_text, row, column_count): pass
    ...
    def is_in_strict_model(self, dialog): pass

    def retranslate_title(self, dialog, search_mode): pass

    def search_class(self, searchable_classes): pass

    def search_property(self, searchable_properties): pass
...
class UseCase:
    def _connect_views(self, proxy_view, view): pass

    def add_editable_header_to_view(self, view): pass

    def add_header_view(self, project): pass

    def add_models_to_window(self, project): pass

    def connect_class_views(self, ): pass

    def connect_models(self, ): pass

    def connect_project_view(self, ): pass

    def connect_property_views(self, ): pass

    def connect_signals(self, ): pass

    def create_context_menu(self, menu_list, pos): pass

    def create_header_views(self, project, first_columns): pass
    ...
    def get_class_header_model(self, ): pass

    def get_class_model(self, ): pass

    def get_class_views(self, ): pass

    def get_mouse_press_checkstate(self, ): pass

    def get_project_model(self, ): pass

    def get_project_view(self, ): pass

    def get_properties(self, ): pass

    def get_property_header_model(self, ): pass

    def get_property_label(self, ): pass

    def get_property_model(self, ): pass

    def get_property_views(self, ): pass

    def get_window(self, ): pass

    def is_mouse_pressed(self, ): pass

    def set_action(self, name, action): pass

    def set_mouse_press_checkstate(self, checkstate): pass

    def set_mouse_pressed(self, pressed): pass
...
class Util:
    ...
    def fill_list_widget_with_checkstate(self, list_widget, allowed_labels, all_labels): pass

    def fill_main_property(self, widget, pset_name, property_name, pset_placeholder, property_placeholder): pass

    def get_combobox_values(self, combo_box): pass

    def get_greyed_out_brush(self, ): pass
    ...
    def get_property(self, widget): pass

    def get_standard_text_brush(self, ): pass

    def get_text_from_combobox(self, combobox): pass

    def get_window_title(self, window_name): pass

    def insert_tab_order(self, previous_widget, inserted_widget): pass
    ...
    def user_is_using_darkmode(self, ): pass
