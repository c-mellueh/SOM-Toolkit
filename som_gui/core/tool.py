...
class ClassInfo:
    ...
    def create_dialog(self, title): pass
...
class PropertySet:
    ...
    def is_pset_allready_existing(self, pset_name, active_class): pass
    ...
    def search_for_parent(self, pset_name, predefined_psets, parent_psets): pass
    ...
    def update_completer(self, som_class): pass
