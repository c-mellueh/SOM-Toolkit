...
class Appdata:
    ...
    def get_list_setting(self, section, path, default): pass
...
class Class:
    ...
    def clear_tree(self, ): pass

    def collapse_selection(self, ): pass

    def copy_class(self, som_class, data_dict): pass

    def copy_group(self, som_class): pass
    ...
    def delete_class(self, obj, recursive): pass
    ...
    def fill_class_entry(self, obj): pass

    def fill_class_tree(self, objects, parent_item): pass

    def find_property(self, obj, pset_name, attribute_name): pass
    ...
    def get_item_from_class(self, obj): pass

    def get_item_from_pos(self, pos): pass

    def get_properties(self, ): pass

    def get_selected_classes(self, ): pass
    ...
    def remove_column_from_tree(self, column_name): pass

    def resize_tree(self, ): pass

    def select_class(self, obj): pass

    def set_active_class(self, obj): pass
...
class ClassInfo:
    ...
    def oi_fill_properties(self, mode, selected_class): pass
    ...
    def trigger_class_info_widget(self, mode): pass
...
class PropertyImportResults:
    def build_property_dict(self, objects): pass
...
class PropertyImportSQL:
    ...
    def import_entity_properties(self, entity, ifc_file, identifier, existing_object_dict): pass
...
class Search:
    ...
    def search_class(self, searchable_objects): pass
