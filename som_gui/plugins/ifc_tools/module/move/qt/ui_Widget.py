...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.widget_file_selector.setObjectName("widget_file_selector")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", "X-Movement [m]", None))
        self.label_2.setText(QCoreApplication.translate("Form", "Y-Movement [m]", None))
        self.label_3.setText(QCoreApplication.translate("Form", "Z-Movement [m]", None))
