...
def paint_connection(
    active_connection: ui_connection.Connection, connection: Type[tool.Connection]
) -> None:
    ...
    path = connection.calculate_painter_path(
        point_top, point_bottom, displacement, active_connection.connection_type
    )
