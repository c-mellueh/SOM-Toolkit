...
class Ui_Project(object):
    def setupUi(self, Project):
        ...
        self.formLayout.setWidget(1, QFormLayout.ItemRole.FieldRole, self.le_version)
        ...
        self.le_author_mail.setObjectName("le_author_mail")

        self.formLayout.setWidget(
            2, QFormLayout.ItemRole.FieldRole, self.le_author_mail
        )
        ...
        self.formLayout.setWidget(
            3, QFormLayout.ItemRole.FieldRole, self.le_description
        )
    ...
    def retranslateUi(self, Project):
        Project.setWindowTitle(QCoreApplication.translate("Project", "Form", None))
        self.label_2.setText(
            QCoreApplication.translate("Project", "Project Name:", None)
        )
        self.label_3.setText(QCoreApplication.translate("Project", "Version:", None))
        self.label_4.setText(
            QCoreApplication.translate("Project", "Author Email:", None)
        )
        self.label.setText(QCoreApplication.translate("Project", "Description:", None))
