...
class Ui_Project(object):
    def setupUi(self, Project):
        ...
        self.formLayout.setWidget(2, QFormLayout.ItemRole.FieldRole, self.le_author_mail)
        ...
        self.formLayout.setWidget(3, QFormLayout.ItemRole.FieldRole, self.le_description)
