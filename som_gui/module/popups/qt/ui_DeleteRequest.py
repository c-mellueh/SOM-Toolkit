...
class Ui_DeleteRequest(object):
    ...
    def retranslateUi(self, DeleteRequest):
        DeleteRequest.setWindowTitle(
            QCoreApplication.translate("DeleteRequest", "Dialog", None)
        )
        self.label.setText(
            QCoreApplication.translate(
                "DeleteRequest", "delete the following entities?", None
            )
        )
        self.check_box_recursion.setText(
            QCoreApplication.translate(
                "DeleteRequest", "Also delete child elements?", None
            )
        )
