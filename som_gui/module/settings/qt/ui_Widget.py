...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.pagePropertySet = QWidget()
        self.pagePropertySet.setObjectName(u"pagePropertySet")
        self.pagePropertySet.setGeometry(QRect(0, 0, 840, 485))
        self.verticalLayout_12 = QVBoxLayout(self.pagePropertySet)
        self.verticalLayout_12.setObjectName(u"verticalLayout_12")
        self.tb_property_set.addItem(self.pagePropertySet, u"Splitter")
        self.page = QWidget()
        self.page.setObjectName(u"page")
        self.page.setContextMenuPolicy(Qt.ContextMenuPolicy.PreventContextMenu)
        self.verticalLayout_13 = QVBoxLayout(self.page)
        self.verticalLayout_13.setObjectName(u"verticalLayout_13")
        self.tb_property_set.addItem(self.page, u"Units")
    ...
    def retranslateUi(self, Settings):
        ...
        self.tb_property_set.setItemText(self.tb_property_set.indexOf(self.pagePropertySet), QCoreApplication.translate("Settings", u"Splitter", None))
        self.tb_property_set.setItemText(self.tb_property_set.indexOf(self.page), QCoreApplication.translate("Settings", u"Units", None))
