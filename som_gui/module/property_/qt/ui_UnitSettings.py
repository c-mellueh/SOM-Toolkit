...
class Ui_UnitSettings(object):
    def setupUi(self, UnitSettings):
        ...
        self.list_units.setObjectName("list_units")
        ...
        self.list_prefixes.setObjectName("list_prefixes")
    ...
    def retranslateUi(self, UnitSettings):
        UnitSettings.setWindowTitle(
            QCoreApplication.translate("UnitSettings", "Form", None)
        )
        self.label_3.setText(QCoreApplication.translate("UnitSettings", "Units", None))
        self.label_2.setText(
            QCoreApplication.translate("UnitSettings", "Unit Prefixes", None)
        )
