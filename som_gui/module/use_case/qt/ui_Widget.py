...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.class_splitter.setObjectName("class_splitter")
        ...
        self.class_treeView_fixed.setObjectName("class_treeView_fixed")
        ...
        sizePolicy1.setHeightForWidth(
            self.class_treeView_fixed.sizePolicy().hasHeightForWidth()
        )
        self.class_treeView_fixed.setSizePolicy(sizePolicy1)
        self.class_treeView_fixed.setVerticalScrollBarPolicy(
        ...
        self.class_treeView_extendable.setObjectName("class_treeView_extendable")
        ...
        sizePolicy2.setHeightForWidth(
            self.class_treeView_extendable.sizePolicy().hasHeightForWidth()
        )
        self.class_treeView_extendable.setSizePolicy(sizePolicy2)
        ...
        self.property_TableView_fixed.setObjectName("property_TableView_fixed")
        self.property_TableView_fixed.setHorizontalScrollMode(
        ...
        self.property_TableView_extendable.setObjectName(
            "property_TableView_extendable"
        )
        sizePolicy2.setHeightForWidth(
            self.property_TableView_extendable.sizePolicy().hasHeightForWidth()
        )
        self.property_TableView_extendable.setSizePolicy(sizePolicy2)
        self.property_TableView_extendable.setHorizontalScrollMode(
            QAbstractItemView.ScrollMode.ScrollPerPixel
        )
        self.splitter.addWidget(self.property_TableView_extendable)
        self.property_TableView_extendable.verticalHeader().setVisible(False)
