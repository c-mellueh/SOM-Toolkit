...
from som_gui.module.attribute_import.ui import (
    PropertyTable,
    IfcTypeComboBox,
    PropertySetTable,
    SOMTypeComboBox,
...
class Ui_AttributeImport(object):
    def setupUi(self, AttributeImport):
        if not AttributeImport.objectName():
            AttributeImport.setObjectName("AttributeImport")
        ...
        sizePolicy1.setHeightForWidth(
            self.label_object_count.sizePolicy().hasHeightForWidth()
        )
        ...
        self.vertival_layout_pset.setObjectName("vertival_layout_pset")
        ...
        self.vertical_layout_attribute.setObjectName("vertical_layout_attribute")
        ...
        sizePolicy1.setHeightForWidth(
            self.label_attributes.sizePolicy().hasHeightForWidth()
        )
        ...
        self.table_widget_property.setObjectName("table_widget_attribute")
        sizePolicy3.setHeightForWidth(
    ...
    def retranslateUi(self, AttributeImport):
        AttributeImport.setWindowTitle(
            QCoreApplication.translate("AttributeImport", "Form", None)
        )
        self.label_object_count.setText(
            QCoreApplication.translate("AttributeImport", "Count", None)
        )
        self.label_proeprty_sets.setText(
            QCoreApplication.translate("AttributeImport", "PropertySets", None)
        )
        self.label_attributes.setText(
            QCoreApplication.translate("AttributeImport", "Attribute", None)
        )
        self.check_box_values.setText(
            QCoreApplication.translate("AttributeImport", "All", None)
        )
        self.label_value.setText(
            QCoreApplication.translate("AttributeImport", "Values", None)
        )
