...
################################################################################
## Form generated from reading UI file 'attribute_compare_widget.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy.setHeightForWidth(self.tree_widget_object.sizePolicy().hasHeightForWidth())
        self.tree_widget_object.setSizePolicy(sizePolicy)
