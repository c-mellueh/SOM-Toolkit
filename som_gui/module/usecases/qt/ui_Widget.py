...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy1.setHeightForWidth(self.class_treeView_fixed.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy2.setHeightForWidth(self.class_treeView_extendable.sizePolicy().hasHeightForWidth())
        ...
        self.property_TableView_fixed.setHorizontalScrollMode(QAbstractItemView.ScrollMode.ScrollPerPixel)
        ...
        sizePolicy2.setHeightForWidth(self.property_TableView_extendable.sizePolicy().hasHeightForWidth())
        self.property_TableView_extendable.setSizePolicy(sizePolicy2)
        self.property_TableView_extendable.setHorizontalScrollMode(QAbstractItemView.ScrollMode.ScrollPerPixel)
