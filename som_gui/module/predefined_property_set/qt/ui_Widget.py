...
class Ui_PredefinedPset(object):
    def setupUi(self, PredefinedPset):
        if not PredefinedPset.objectName():
            PredefinedPset.setObjectName("PredefinedPset")
        ...
        self.layout_pset.setObjectName("layout_pset")
        ...
        self.button_pset.setObjectName("button_pset")
        ...
        self.list_view_pset.setObjectName("list_view_pset")
        ...
        self.list_view_pset.setEditTriggers(
        ...
        self.layout_inheritance.setObjectName("layout_inheritance")
        ...
        self.button_property.setObjectName("button_property")
        ...
        sizePolicy.setHeightForWidth(
            self.table_properties.sizePolicy().hasHeightForWidth()
        )
        self.table_properties.setSizePolicy(sizePolicy)
        self.table_properties.setContextMenuPolicy(
            Qt.ContextMenuPolicy.CustomContextMenu
        )
        self.table_properties.setEditTriggers(
        ...
        self.layout_property.setObjectName("layout_property")
        ...
        self.table_widgets_classes.setObjectName("table_widgets_classes")
        self.table_widgets_classes.setContextMenuPolicy(
            Qt.ContextMenuPolicy.CustomContextMenu
        )
        self.table_widgets_classes.setEditTriggers(
            QAbstractItemView.EditTrigger.NoEditTriggers
        )
        self.table_widgets_classes.setSelectionMode(
    ...
    def retranslateUi(self, PredefinedPset):
        PredefinedPset.setWindowTitle(
            QCoreApplication.translate("PredefinedPset", "Dialog", None)
        )
        self.label.setText(
            QCoreApplication.translate("PredefinedPset", "PropertySet", None)
        )
        self.button_pset.setText(
            QCoreApplication.translate("PredefinedPset", "New", None)
        )
        self.label_properties.setText(
            QCoreApplication.translate("PredefinedPset", "Properties:", None)
        )
        self.button_property.setText(
            QCoreApplication.translate("PredefinedPset", "New", None)
        )
        self.label_2.setText(
            QCoreApplication.translate("PredefinedPset", "Inherits to:", None)
        )
        ___qtablewidgetitem = self.table_widgets_classes.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(
            QCoreApplication.translate("PredefinedPset", "Name", None)
        )
        ___qtablewidgetitem1 = self.table_widgets_classes.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(
            QCoreApplication.translate("PredefinedPset", "Identifier", None)
        )
