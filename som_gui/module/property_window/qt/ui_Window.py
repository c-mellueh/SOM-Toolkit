...
class Ui_PropertyWindow(object):
    def setupUi(self, PropertyWindow):
        ...
        sizePolicy2.setHeightForWidth(
            self.table_view_value.sizePolicy().hasHeightForWidth()
        )
        self.table_view_value.setSizePolicy(sizePolicy2)
        self.table_view_value.setContextMenuPolicy(
        ...
        self.table_view_value.setSelectionMode(
            QAbstractItemView.SelectionMode.ExtendedSelection
        )
        self.table_view_value.setSelectionBehavior(
    ...
    def retranslateUi(self, PropertyWindow):
        PropertyWindow.setWindowTitle(
            QCoreApplication.translate("PropertyWindow", "Form", None)
        )
        ...
        self.label_2.setText(
            QCoreApplication.translate("PropertyWindow", "Valuetype:", None)
        )
        self.label.setText(
            QCoreApplication.translate("PropertyWindow", "Datatype:", None)
        )
        self.label_3.setText(
            QCoreApplication.translate("PropertyWindow", "Unit:", None)
        )
        self.button_add_line.setText(
            QCoreApplication.translate("PropertyWindow", "+", None)
        )
