...
class Ui_PropertyWindow(object):
    def setupUi(self, PropertyWindow):
        ...
        self.table_view_value = ValueView(PropertyWindow)
        self.table_view_value.setObjectName(u"table_view_value")
        self.table_view_value.setEditTriggers(QAbstractItemView.EditTrigger.AllEditTriggers)
        ...
        self.verticalLayout_3.addWidget(self.table_view_value)
