...
class Ui_SplitterSettings(object):
    def setupUi(self, SplitterSettings):
        if not SplitterSettings.objectName():
            SplitterSettings.setObjectName("SplitterSettings")
        ...
        self.line_edit_seperator.setObjectName("line_edit_seperator")
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Ignored, QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.line_edit_seperator.sizePolicy().hasHeightForWidth()
        )
        ...
        self.check_box_seperator.setObjectName("check_box_seperator")
    ...
    def retranslateUi(self, SplitterSettings):
        SplitterSettings.setWindowTitle(
            QCoreApplication.translate("SplitterSettings", "Form", None)
        )
        self.line_edit_seperator.setPlaceholderText(
            QCoreApplication.translate("SplitterSettings", "Splitter text", None)
        )
        self.check_box_seperator.setText(
            QCoreApplication.translate("SplitterSettings", "Use Splitter", None)
        )
