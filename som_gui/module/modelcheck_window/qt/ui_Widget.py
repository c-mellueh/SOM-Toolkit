...
class Ui_Modelcheck(object):
    def setupUi(self, Modelcheck):
        ...
        self.main_attribute_widget = PropertySelector(Modelcheck)
        ...
        self.scroll_area_progress_bar.setObjectName("scroll_area_progress_bar")
        ...
        sizePolicy1.setHeightForWidth(
            self.scroll_area_progress_bar.sizePolicy().hasHeightForWidth()
        )
        self.scroll_area_progress_bar.setSizePolicy(sizePolicy1)
        self.scroll_area_progress_bar.setMaximumSize(QSize(16777215, 300))
        self.scroll_area_progress_bar.setVerticalScrollBarPolicy(
            Qt.ScrollBarPolicy.ScrollBarAsNeeded
        )
        self.scroll_area_progress_bar.setHorizontalScrollBarPolicy(
    ...
    def retranslateUi(self, Modelcheck):
        Modelcheck.setWindowTitle(
            QCoreApplication.translate("Modelcheck", "Form", None)
        )
