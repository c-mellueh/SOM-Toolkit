...
class Ui_PropertySetWindow(object):
    ...
    def retranslateUi(self, PropertySetWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("PropertySetWindow", u"Valuetype:", None))
        self.label.setText(QCoreApplication.translate("PropertySetWindow", u"Datatype:", None))
        self.label_3.setText(QCoreApplication.translate("PropertySetWindow", u"Unit:", None))
        ...
        self.label_values.setText(QCoreApplication.translate("PropertySetWindow", u"Allowed Values:", None))
    # retranslateUi
