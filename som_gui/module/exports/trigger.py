...
def connect():
    ...
    tool.MainWindow.add_action("Datei/Export/Card1",
                               lambda: core.export_card_1(tool.Exports, tool.MainWindow, tool.Project))
    tool.MainWindow.add_action("Datei/Export/Excel",
                               lambda: core.export_excel(tool.Exports, tool.MainWindow, tool.Project))
    ...
    tool.MainWindow.add_action("Desite/Lesezeichen",
                               lambda: core.export_bookmarks(tool.Exports, tool.MainWindow, tool.Project))
