...
class Ui_FilterWindow(object):
    def setupUi(self, FilterWindow):
        ...
        self.label_usecase.setObjectName("label_usecase")

        self.verticalLayout.addWidget(self.label_usecase)

        self.widget_usecase = QWidget(FilterWindow)
        self.widget_usecase.setObjectName("widget_usecase")
        sizePolicy.setHeightForWidth(
            self.widget_usecase.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, FilterWindow):
        FilterWindow.setWindowTitle(
            QCoreApplication.translate("FilterWindow", "Form", None)
        )
        self.label_phase.setText(
            QCoreApplication.translate("FilterWindow", "Phase", None)
        )
        self.label_usecase.setText(
            QCoreApplication.translate("FilterWindow", "Usecase", None)
        )
